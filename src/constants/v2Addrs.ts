...
export const LB_QUOTER_V21_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.FUJI]: '0x3660268Ed43583a2cdd09e3fC7079ff07DBD4Caa',
  [ChainId.AVALANCHE]: '0x3660268Ed43583a2cdd09e3fC7079ff07DBD4Caa',
  [ChainId.ARBITRUM_ONE]: '0x3660268Ed43583a2cdd09e3fC7079ff07DBD4Caa',
  [ChainId.ARB_GOERLI]: '0xce8aFc7cDfbAaa3B2d0053505575472853687AFd',
  [ChainId.BNB_CHAIN]: '0x3660268Ed43583a2cdd09e3fC7079ff07DBD4Caa',
  [ChainId.BNB_TESTNET]: '0xCccB0F287A009A319EEaE090ED3F4C2768fFC570'
}
...
export const LB_ROUTER_V21_ADDRESS: { [chainId in ChainId]: string } = {
...
export const LB_FACTORY_V21_ADDRESS: { [chainId in ChainId]: string } = {
